...
<template>
  <div class="homepage">
    <!-- Sidebar -->
    <div class="sidebar">
      <label class="sidebar-btn" @click="router.push('/admin/dashboard')">Home</label>
      <label v-if="username!=null" class="sidebar-btn" @click="router.push('/admin/dashboard/user-list')">User List</label>
