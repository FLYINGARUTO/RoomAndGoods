...
CREATE TABLE `collect` (
  ...
  `from_user` varchar(255) NOT NULL COMMENT '收藏的用户',
  `to_id` int NOT NULL COMMENT '被收藏的用户',
  `post_id` int NOT NULL COMMENT '被收藏的帖子',
  `created_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `only star once` (`from_user`,`post_id`),
  KEY `collect-post` (`post_id`),
  CONSTRAINT `collect-post` FOREIGN KEY (`post_id`) REFERENCES `post` (`id`) ON DELETE CASCADE
...
-- ----------------------------
BEGIN;
INSERT INTO `collect` (`id`, `from_user`, `to_id`, `post_id`, `created_time`) VALUES (2, 'Sean', 3, 1, '2025-02-25 15:04:36');
INSERT INTO `collect` (`id`, `from_user`, `to_id`, `post_id`, `created_time`) VALUES (7, 'Sean', 1, 6, '2025-02-25 15:11:52');
INSERT INTO `collect` (`id`, `from_user`, `to_id`, `post_id`, `created_time`) VALUES (8, 'Sean', 1, 42, '2025-02-25 15:12:04');
INSERT INTO `collect` (`id`, `from_user`, `to_id`, `post_id`, `created_time`) VALUES (9, 'Rachel', 1, 6, '2025-02-25 15:15:42');
COMMIT;
...
INSERT INTO `comment` (`id`, `from_id`, `post_id`, `to_id`, `comment`, `read`, `create_time`, `from_user`) VALUES (26, NULL, 22, 1, '几升的', 0, '2025-02-24 23:25:58', 'Sean');
INSERT INTO `comment` (`id`, `from_id`, `post_id`, `to_id`, `comment`, `read`, `create_time`, `from_user`) VALUES (27, NULL, 27, 1, '几钱出', 0, '2025-02-25 15:18:31', 'Rachel');
COMMIT;
...
INSERT INTO `like` (`id`, `from_user`, `to_id`, `post_id`, `created_time`) VALUES (29, 'Sean', 1, 6, '2025-02-25 15:11:57');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `post` (`id`, `publisher_id`, `title`, `details`, `views`, `likes`, `category`, `create_time`, `delete_time`, `stars`, `comments`, `publisher`) VALUES (1, 1, '出二手投影仪', '100镑不刀', 169, 1, 'Used', '2025-02-12 17:18:53', NULL, 3, 0, 'Sean');
...
INSERT INTO `post` (`id`, `publisher_id`, `title`, `details`, `views`, `likes`, `category`, `create_time`, `delete_time`, `stars`, `comments`, `publisher`) VALUES (6, 1, '出刚开封老抽', '1镑自取', 246, 1, 'Used', '2025-02-14 13:37:18', NULL, 2, 0, 'Sean');
...
INSERT INTO `post` (`id`, `publisher_id`, `title`, `details`, `views`, `likes`, `category`, `create_time`, `delete_time`, `stars`, `comments`, `publisher`) VALUES (17, 1, '便宜出switch', '两年前英国购入，使用频率不高，140镑出，送塞尔达', 7, 0, 'Used', '2025-02-18 01:02:34', NULL, 0, 0, 'Sean');
...
INSERT INTO `post` (`id`, `publisher_id`, `title`, `details`, `views`, `likes`, `category`, `create_time`, `delete_time`, `stars`, `comments`, `publisher`) VALUES (22, 1, '出北面登山包', '50镑自提', 6, 0, 'Used', '2025-02-18 12:54:21', NULL, 0, 0, 'Sean');
...
INSERT INTO `post` (`id`, `publisher_id`, `title`, `details`, `views`, `likes`, `category`, `create_time`, `delete_time`, `stars`, `comments`, `publisher`) VALUES (27, 1, '出山寨劳力士', 'learning hub面交', 8, 0, 'Used', '2025-02-19 14:12:15', NULL, 0, 0, 'Sean');
INSERT INTO `post` (`id`, `publisher_id`, `title`, `details`, `views`, `likes`, `category`, `create_time`, `delete_time`, `stars`, `comments`, `publisher`) VALUES (28, 1, '周六求跑腿', '有偿', 4, 0, 'Other', '2025-02-19 14:21:14', NULL, 0, 0, 'Sean');
INSERT INTO `post` (`id`, `publisher_id`, `title`, `details`, `views`, `likes`, `category`, `create_time`, `delete_time`, `stars`, `comments`, `publisher`) VALUES (29, 1, '出荷花', '60rmb一包', 22, 0, 'Used', '2025-02-23 13:21:45', NULL, 0, 0, 'Sean');
...
INSERT INTO `post` (`id`, `publisher_id`, `title`, `details`, `views`, `likes`, `category`, `create_time`, `delete_time`, `stars`, `comments`, `publisher`) VALUES (42, 1, 'who wants to travel to Edinburgh', 'tomorrow', 82, 1, 'Other', '2025-02-23 15:29:14', NULL, 1, 0, 'Sean');
